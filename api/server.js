...
const SPOTS_DATA = [
  {
    ...
    attributes: {
      ...
      widget: '//www.surf-forecast.com/breaks/La-Arena-1/forecasts/widget/a',
    },
    relationships: {},
  },
  {
    ...
    attributes: {
      ...
      name: 'Sopela',
      webcams: [
        'http://www.kostasystem.com/wp-content/uploads/irudiak/arriatera/camara1_snap.jpeg',
        'http://www.kostasystem.com/wp-content/uploads/irudiak/arriatera/camara2_snap.jpeg',
      ],
    },
    relationships: {},
  },
